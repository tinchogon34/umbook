...
if(_3b.getAttribute("xlink:href")!=""){
_3d.setAttribute("href",_3b.getAttribute("xlink:href"));
}
...
rabbit.result.manager.setClass=function(_5d,_5e){
var css={};
if(_5e!=""){
css=rabbit.vml.getStyleForClass(_5e);
}
var _5f=_5d.style.cssText.split(";");
for(var k=0;k<_5f.length;k++){
cssItem=_5f[k].split(":");
css[cssItem[0].toLowerCase().replace(" ","")]=cssItem[1].replace(" ","");
}
rabbit.vml.setStyle(_5d,css,_5d.ownerDocument);
};
rabbit.result.manager.init=function(_60){
try{
var _61=document.getElementById("pageData").firstChild;
var _62="";
while(_61!=null){
_62+=_61.nodeValue;
_61=_61.nextSibling;
}
this.pageData=Ext.util.JSON.decode(_62).pages;
var _63=document.getElementsByTagName("div");
this.layers=new Array();
for(var i=0;i<_63.length;i++){
if(_63[i].getAttribute("name")=="layer"){
this.layers.push(_63[i]);
}
}
for(var _64 in this.pageData){
var _65=selectorUtil.getElementsByName("target"+_64);
for(var i=0;i<_65.length;i++){
if(_65[i].childNodes.length==2){
_65[i].firstChild.style.display="block";
_65[i].firstChild.nextSibling.style.display="none";
}else{
_65[i].getElementsByTagName("fill")[0].setAttribute("color","white");
_65[i].getElementsByTagName("fill")[0].setAttribute("on","true");
}
}
}
...
rabbit.result.manager.changeTab=function(_66){
var _67=selectorUtil.getElementsByName("target"+this.currentPageId);
for(var i=0;i<_67.length;i++){
if(_67[i].childNodes.length==2){
_67[i].firstChild.style.display="block";
_67[i].firstChild.nextSibling.style.display="none";
}else{
_67[i].getElementsByTagName("fill")[0].setAttribute("color","white");
}
}
var _67=selectorUtil.getElementsByName("target"+_66);
for(var i=0;i<_67.length;i++){
if(_67[i].childNodes.length==2){
_67[i].firstChild.style.display="none";
_67[i].firstChild.nextSibling.style.display="block";
}else{
_67[i].getElementsByTagName("fill")[0].setAttribute("color","#D3D3D3");
}
}
this.currentPageId=_66;
};
YAHOO.widget.Menu.prototype._onBeforeShow=function(_68,_69){
var _6a,n,_6b,_6c=this.cfg.getProperty("container");
...
_6b=this.srcElement;
if(_6b){
if(_6b.tagName.toUpperCase()=="SELECT"){
if(Dom.inDocument(_6b)){
this.render(_6b.parentNode);
}else{
this.render(_6c);
}
}else{
...
var _6d=this.parent,_6e;
if(!_6d&&this.cfg.getProperty("position")=="dynamic"){
this.cfg.refireEvent("xy");
}
if(_6d){
_6e=_6d.parent.cfg.getProperty("submenualignment");
this._initSubTree();
this.cfg.setProperty("context",[_6d.element,_6e[0],_6e[1]]);
this.align();
}
};
